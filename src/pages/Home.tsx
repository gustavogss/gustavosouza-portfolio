  ...
  const features = [
    {
      ...
      description:
        "Desenvolvimento completo de aplicações web e mobile com as melhores tecnologias.",
    },
    {
      icon: Shield,
      title: "DevSecOps",
      description:
        "Implementação de segurança em todas as etapas do desenvolvimento.",
    },
    {
      icon: Zap,
      title: "Performance",
      description:
        "Otimização e escalabilidade para aplicações de alta performance.",
    },
  ];
      ...
      <div className="min-h-screen">
        ...
        <div ref={heroRef} className="py-20">
          ...
          <p className="text-xl text-muted-foreground max-w-2xl mb-12">
            Especializado em criar soluções completas e seguras, desde o
            frontend até a infraestrutura, com foco em qualidade, performance e
